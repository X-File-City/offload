...
Each file contains stdout and stderr from all tests in that batch, prefixed with the test ID. Cancelled batches (e.g., from early stopping) do not produce log files.
